class argHandler(dict):
    ...
    def setDefaults(self):
        ...
        self.define('config', 'model/cfg/', 'path to .cfg directory')
        self.define('dataset', '../pascal/VOCdevkit/IMG/', 'path to dataset directory')
        self.define('labels', 'model/labels.txt', 'path to labels file')
        self.define('backup', 'model/ckpt/', 'path to backup folder')
